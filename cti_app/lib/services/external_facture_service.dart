...
class ExternalFactureService {
  static Future<void> generateAndPrintFacture({
    required ExternalOrder externalOrder,
    required FactureFournisseur facture,
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        footer: (pw.Context context) => pw.Column(
          children: [
            pw.Row(
              children: [
                pw.Expanded(
                  child: _buildPaymentConditionsTable(facture, externalOrder),
                ),
                pw.SizedBox(width: 30),
                pw.Expanded(
                  child: _buildTotalsSection(totalHT, tva, totalTTC, externalOrder),
                ),
              ],
            ),
        ...
        build: (pw.Context context) => [
          ...
          _buildProductsTable(externalOrder),
            ...
            pw.Expanded(
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 6),
                  _buildFactureInfo(facture, supplier, context),
                  pw.SizedBox(height: 6),
                  _buildSupplierInfo(supplier, facture)
                ],
              ),
            ),
          ],
      ...
      children: [
        ...
        pw.Column(
          ...
          children: [
            ...
            pw.Text('Matériel Informatique - Fourniture - Mobilier', style: const pw.TextStyle(fontSize: 8)),
  ...
  static pw.Widget _buildFactureTitle(FactureFournisseur facture) {
    return pw.Container(
      ...
      child: pw.Text('FACTURE N° ${facture.ref}', 
          style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 14)),
    );
  }

  static pw.Widget _buildFactureInfo(FactureFournisseur facture, Supplier supplier, pw.Context context) {
    return pw.Container(
      decoration: pw.BoxDecoration(
        border: pw.Border.all(width: 0.5),
        borderRadius: pw.BorderRadius.circular(8),
          ...
          pw.TableRow(
            children: [
              ...
              pw.Container(
                padding: const pw.EdgeInsets.all(4),
                alignment: pw.Alignment.center,
                child: pw.Text('FOURNISSEUR', style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
              ),
              pw.Container(
                padding: const pw.EdgeInsets.all(4),
                alignment: pw.Alignment.center,
          ...
          pw.TableRow(
            children: [
              ...
              pw.Container(
                padding: const pw.EdgeInsets.all(4),
                alignment: pw.Alignment.center,
                child: pw.Text(supplier.ice, style: const pw.TextStyle(fontSize: 10)),
              ),
              pw.Container(
                padding: const pw.EdgeInsets.all(4),
                alignment: pw.Alignment.center,
  ...
  static pw.Widget _buildSupplierInfo(Supplier supplier, FactureFournisseur facture) {
    return pw.Container(
      width: double.infinity,
      padding: const pw.EdgeInsets.all(6),
      decoration: pw.BoxDecoration(
      ...
      child: pw.Column(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
        children: [
          pw.Text(facture.supplierName, style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
          pw.SizedBox(height: 10),
          pw.Row(
            children: [
              pw.Text('ICE : ', style: const pw.TextStyle(fontSize: 10)),
              pw.Text(supplier.ice, style: const pw.TextStyle(fontSize: 10)),
            ]
          ),
          pw.Text(supplier.address, style: const pw.TextStyle(fontSize: 10)),
          pw.SizedBox(height: 10),
          pw.Text('Tél : ${supplier.phone}', style: const pw.TextStyle(fontSize: 10)),
        ],
      ),
    );
  }

  static pw.Widget _buildProductsTable(ExternalOrder order) {
  ...
  static pw.Widget _buildTotalsText(double totalTTC, FactureFournisseur facture) {
    return pw.Row(
  ...
  static pw.Widget _buildTotalsSection(double totalHT, double tva, double totalTTC, ExternalOrder order) {
    return pw.Column(
      children: [
        pw.Container(
          width: double.infinity,
          ...
          child: pw.Table(
            ...
            children: [
              ...
              pw.TableRow(
                children: [
                  _buildTableCell(totalHT.toStringAsFixed(2)),
                  _buildTableCell(tva.toStringAsFixed(2)),
                  _buildTableCell(totalTTC.toStringAsFixed(2)),
                ],
              ),
            ],
          ),
        ...
        pw.Container(
          ...
          child: pw.Text('NET A PAYER : ${totalTTC.toStringAsFixed(2)} MAD', 
              style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 14)),
        ),
      ],
    );
  ...
  static pw.Widget _buildPaymentConditionsTable(FactureFournisseur facture, ExternalOrder order) {
    return pw.Container(
      width: double.infinity,
      decoration: pw.BoxDecoration(
        border: pw.Border.all(width: 0.5),
      ...
      child: pw.Column(
        ...
        children: [
          pw.Container(
            ...
            padding: const pw.EdgeInsets.all(4),
            alignment: pw.Alignment.center,
            child: pw.Text('CONDITIONS DE REGLEMENT', 
  ...
  static String _numberToWords(double number) {
    ...
    String convertBelowThousand(int n) {
      ...
      if (n < 100) {
        ...
        if (ten == 7 || ten == 9) {
          return tens[ten - 1] + (unit == 1 ? '-et-' : '-') + units[10 + unit].toLowerCase();
        } else {
        ...
        String hundredText = (hundred > 1 ? '${units[hundred]} Cent' : 'Cent') + (remainder == 0 ? '' : ' ');
