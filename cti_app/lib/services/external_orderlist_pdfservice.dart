...
class ExternalOrderlistPdfservice {
  static Future<Uint8List> generateExternalOrdersPdf(List<ExternalOrder> orders) async {
  ...
  static pw.Widget _buildOrdersTable(List<ExternalOrder> orders) {
